...
echo ""
echo "For local Docker Compose only:"
echo "  docker compose up --build"
echo ""
echo "For Coolify production deployment:"
echo "  Deploy TWO separate Dockerfile resources:"
echo "    - nexus (public) on port 37291"
echo "    - wisp (internal-only) on port 37292"
echo "  Set PUBLIC_WISP_URL=wss://nexus.garfield-math.xyz/wisp/"
echo ""
